...
- The small form factor makes our robot more agile on the playing field compared to our test robot. At first I had my concerns about the center of gravity being too high, but it turned out fine in the end. 
