...
In my opinion the course offers a person to gain experience in several spheres, be it mechanics, electronics or programming. The instructors are understanding and helpful if you happen to run into any issues. The practical, communication skills gained in this course are valuable.
