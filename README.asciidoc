...
Also, revised cross-checking the electronics design is an important task that should be carried out. We missed out a connectionnin one of the power pads, which created a mess actually. So for next time, I would give more attention to these minute details.
